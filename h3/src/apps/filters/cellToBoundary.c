 ...
 * cell boundaries
 *
 *  See `cellToBoundary --help` for usage.
 *
 ...
 *  cellToBoundary" respectively.
 *
 *  Examples:
 *
 *     `cellToBoundary < indexes.txt`
 *        - outputs plain text cell boundaries for the H3 indexes contained
 *          in the file `indexes.txt`
 *
 *     `cellToBoundary --kml --kml-name "kml title" --kml-description "h3
...
int main(int argc, char *argv[]) {
    ...
    if (kmlArg.found) {
        ...
        char *kmlDesc = "Generated by cellToBoundary";
