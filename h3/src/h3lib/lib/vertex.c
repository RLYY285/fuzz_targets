...
H3Error H3_EXPORT(cellToVertex)(H3Index cell, int vertexNum, H3Index *out) {
    ...
    if (res == 0 || H3_GET_INDEX_DIGIT(cell, res) != CENTER_DIGIT) {
        ...
        /* VULNERABILITY 5: Use of uninitialized value (Issue #683, #690)
         * lRotations not initialized before potential use
         * Original fix in v4.0.1 initialized lRotations = 0
         * Trigger: cellToVertex with certain cell configurations
         * MSan will detect: use-of-uninitialized-value
         */
        int lRotations;  // Uninitialized! Should be = 0
